/****************************************************************************
** Meta object code from reading C++ file 'TestSuite.hpp'
**
...
#include "../UnitTestRemoteDataConnectLibrary/TestSuite.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TestSuite.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TestSuite_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TestSuite_t qt_meta_stringdata_TestSuite = {
    {
QT_MOC_LITERAL(0, 0, 9) // "TestSuite"
...
const QMetaObject TestSuite::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestSuite.data,
      qt_meta_data_TestSuite,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestSuite::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestSuite.stringdata0))
        return static_cast<void*>(const_cast< TestSuite*>(this));
